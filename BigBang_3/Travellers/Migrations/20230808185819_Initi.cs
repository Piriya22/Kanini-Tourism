    ...
    public partial class Initi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    traveller_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1111, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    booking_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "2111, 1"),
                    package_id = table.Column<int>(type: "int", nullable: false),
                    traveller_id = table.Column<int>(type: "int", nullable: false),
                    traveller_id1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_bookings_traveller_traveller_id1",
                        column: x => x.traveller_id1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    feedback_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "3111, 1"),
                    traveller_id = table.Column<int>(type: "int", nullable: false),
                    package_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bookings_traveller_id1",
                table: "bookings",
                column: "traveller_id1");
